...
class Student extends Person with CourseMixin {
...
class Teacher extends Person with CourseMixin {
  int _salary;
...
mixin CourseMixin {
  List<String> _listCourse = [];

  List<String> get listCourse => _listCourse;
